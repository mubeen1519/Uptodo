...
import com.stellerbyte.uptodo.navigation.EditTodoPage
...
class HomeViewModel @Inject constructor(
    ...
    fun reminderDateChange(newDate: Long){
        ...
        val defaultReminderDateValue = todo.value.date ?: newDateValue
        todo.value = todo.value.copy(reminderDateAndTime = defaultReminderDateValue)
    }
